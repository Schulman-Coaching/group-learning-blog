      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Join discussions about group psychoanalysis, share insights, and connect with practitioners worldwide.
          </p>
        </div>
        ...
        <div className="grid gap-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600">
              The forum requires a database connection to display discussions and allow user interactions.
